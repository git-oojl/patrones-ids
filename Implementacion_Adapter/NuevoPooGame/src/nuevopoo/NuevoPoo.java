...
import externos.SemaforoExterno; // Nuevo import
...
public class NuevoPoo extends PApplet {
    ...
    public void setup() {
        ...
        // objeto externo adaptado
        
        SemaforoExterno semaforoReal = new SemaforoExterno();
        SemaforoAdapter semaforo = new SemaforoAdapter(semaforoReal, "rojo");
        semaforo.setPosicion(new Posicion(540, 220));
        figuras.add(semaforo);
    }
